...
insert into zona(busqueda, idpais, extension)
select ciudad + ', Estados Unidos', 34, case when población > 10000000 then 1000 when población > 3000000 then 700 when población > 1000000 then 500 else 300 end --, [población (2015)]
from ciudades_usa where ciudad not in ('nueva york', 'los angeles')
and población > 500000
--35 (37 en total)
...
insert into zona(busqueda, idpais, extension)
select ciudad + ', Canada', 35, case when población > 800000 then 500 when población > 400000 then 300 else 200 end --, [población (2015)]
from ciudades_canada where ciudad not in ('toronto, ontario')
and población > 250000
--35 (37 en total)
...
--Copenhague, (København) 1.181.239 
...
insert into zona(busqueda, idpais, extension) values('Malmö, Suecia', 50, 200)
...
--añadir suecia, noruega, finlandia, dinamarca 
