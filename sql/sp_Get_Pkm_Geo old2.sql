...
BEGIN
	...
	if @filtro <> ''
	begin
		SELECT top 2500 g.lat, g.lon, propiedad p
		...
		where lat > @dlatSO and lat < @dlatNE
			...
			and p.idPokemon = @filtro

		--falta tabla que relacione generador y todos los pokemon (al menos los 1, 2 y 3 del generador)
